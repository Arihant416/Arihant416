...
const About = () => {
	return (
		<motion.section
			...
			className='bg-gradient-to-b from-[#050505] via-[#111111] to-[#0a0a0a] min-h-screen flex flex-col items-center justify-center text-white py-24 px-6'
		>
			<div className='w-full max-w-6xl mx-auto'>
				...
				<motion.p
					...
					className='text-lg sm:text-xl text-gray-200 mt-6 max-w-4xl mx-auto text-center leading-relaxed'
				>
					Hey there! I'm{' '}
				...
				{/* Divider */}
				<div className='mt-16 w-full h-1 bg-gradient-to-r from-transparent via-indigo-400 to-transparent rounded-full blur-sm opacity-20'></div>
